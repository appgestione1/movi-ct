    ...
    <div className="onboarding planner-page">
      <div className="ob-header">
        <div className="bus-title-row">
          ...
          <h1 className="ob-title" style={{ margin: 0 }}>Bus CT</h1>
        </div>
      ...
      <div className="ob-card planner-card">
        <div className="planner-field">
          ...
          <div className="planner-input-row">
            ...
            <button className="planner-pin-btn" onClick={() => setShowMap('origin')} title="Trova sulla mappa">📍</button>
          </div>
        </div>
        ...
        <div className="planner-field planner-field-dest">
          ...
          <div className="planner-input-row">
            ...
            <button className="planner-pin-btn" onClick={() => setShowMap('dest')} title="Trova sulla mappa">📍</button>
          </div>
        </div>
      </div>
